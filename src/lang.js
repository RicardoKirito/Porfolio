...
const en = {
    home: {
            ...
            projects: [
                {
                    ...
                    description: "This bank app allows users to make payments to their bank cards, get cash advances, know their total debt amount, transfer money, and much more.",
                ...
                },
                {
                    ...
                    description: "This social media app allows you to share experiences with your friends by posting images or text, commenting on your friend's posts, and adding well-known friends.",
                ...
                },
                {
                    ...
                    description: "This real-time chat app allows you to connect with your friends. You can send, edit, and delete messages, upload images, add and delete chats, customize your theme, and more. Give it a try!",
      ...
      skill1: { text: "Can lead to maintainable, secure, clean, and easy to debug code compared to scripting languages." },
      skill2: { text: "Creating alive web pages that interact as your dream web." },
      skill3: { text: "Powerful one-page applications that stand out with versatility and focus." },
      know1: { text: "GET TO KNOW" },
      know2: { text: "ABOUT" },
      know3: { text: "ME" },
      about: { text: "ABOUT" },
      myD: { text: "I help you bring ideas to design, transform design into fully functional webs." },
    ...
    about: {
        ...
        myd: { text: "My name is Ricardo Paniagua, proud of being Dominican. I’m committed to interactivity and creativity." },
        myd2: { text: "Coding is the way I express my problem-solving skills. Crazy about art and all its shapes." },
        gA: { text: "I'M GOOD AT" },
        sp1: { text: "BACK-END" },
        spd1: { text: "I have solid experience developing back-end solutions using C#, Node.js, and SQL Server. My expertise also includes working with MongoDB and Oracle to build scalable and efficient systems." },
        sp2: { text: "FRONT-END" },
            ...
            projects: [
                {
                    ...
                    imgsrc: "./src/assets/video/BankGuard.mp4",
                    description: "Esta aplicación bancaria permite a los usuarios realizar pagos a sus tarjetas bancarias, obtener adelantos en efectivo, conocer el monto total de su deuda, transferir dinero y mucho más.",
                    git: "https://github.com/RicardoKirito/BankGuard",
                    link: ""
                },
                {
                    ...
                    imgsrc: "./src/assets/video/Friends.mp4",
                    description: "Esta aplicación de redes sociales te permite compartir experiencias con tus amigos publicando imágenes o textos, comentando las publicaciones de tus amigos y añadiendo a tus amigos conocidos.",
                    git: "https://github.com/RicardoKirito/Friends",
                    link: ""
                },
                {
                    ...
                    imgsrc: "./src/assets/video/nicochat.mp4",
                    description: "Esta aplicación de chat en tiempo real te permite conectarte con tus amigos. Puedes enviar, editar y eliminar mensajes, subir imágenes, añadir y eliminar chats, personalizar tu tema, y más. ¡Pruébalo!",
                    git: "https://github.com/RicardoKirito/Nicochat.git",
                    link: "https://nicochat.onrender.com"
                }
            ]
...
export function translate(lan, page){
    ...
    for(var elm in  list){
        try{
            ...
            document.querySelector(`[data-lang ='${list[elm]}']`).textContent = lan[page][list[elm]].text
        }catch(err){
            err
        }
    }
